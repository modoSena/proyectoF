...
<head>
    ...
    <link href="<?php echo constant('URL')?>public/css/bootstrap.min.css" rel="stylesheet" id="bootstrap-css">
                ...
                <div class="d-flex justify-content-center h-100">
                    <div class="card ">
                        ...
                        <div class="card-header">
                            <h2 class="text-center text-light">Nueva contraseña</h2>
        ...
        <script>
            $(function () {
                ...
                $('#submitRecuperarContrasena').click(function () {
                   ...
                   $.ajax({
                       url:'<?php echo constant('URL')?>recuperarcontrasena/resgistrarnuevacontrasena',
                       type:'POST',
