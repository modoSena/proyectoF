...
<body>
    ...
    <?php  foreach($this->query as  $fila) { ?>
        <tr>
        <td> <a href='tipoDocumento/actualizartipoDocumentos/<?php echo $fila['idTipo_Documento']?>'><button type='button' class='btn btn-warning'><span class='glyphicon glyphicon-edit'></span></button></a> </td>   
