...
<h2 style="text-align: center; font-family: fantasy;">Actúalizar Tipo Documento</h2>
...
<div class="row">
				<div  class="col-xs-6 col-md-6">
				 <input type="hidden" name="envioActualizotipoDocumento">
				   <input id="submittipoDocumento" name="submittipoDocumento" type="button" value="Actúalizar" class="btn btn-primary btn-block btn-lg" tabindex="7" >
				</div>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      ...
      <div class="modal-content">
        ...
        <div class="modal-header">
          <h2 class="modal-title" id="exampleModalLongTitle">Tipo documento actúalizado con éxito</h2>
        </div>
        <div class="modal-body">
              <p for="">Se ha actúalizado el tipo documento</p> 
        </div>
