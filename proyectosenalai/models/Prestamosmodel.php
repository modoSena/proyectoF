...
class Prestamosmodel extends Model
{
    ...
    public function getElementos($tipoElemento, $Jornada, $fechaInicial)
    {
        ...
        WHERE elementos.idElementos NOT IN (SELECT ep.Elementos_idElementos
                                            ...
                                            WHERE prestamos.jornada_idJornada = :Jornada AND prestamos.Fecha_inicial = :Fecha AND prestamos.Estado_Prestamo = 'E') AND elementos.Estado_Elementos_idEstado_Elementos = 1 AND elementos.Tipo_Equipo_idTipo_Equipo = :tipo AND detalleambiente.Ambientes_idAmbientes = 1";
